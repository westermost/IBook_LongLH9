...
namespace IBook.Areas.Admin.Controllers
{
    ...
    public class OrderBooksController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,AppointmentDate,OrderDate,CustomerName,CustomerAddress,CustomerPhone,isConfirmed")] OrderBook orderBook)
        {
